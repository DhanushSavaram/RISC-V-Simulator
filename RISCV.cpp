...
RISC_V_Instruction decodeInstruction(uint32_t CurrentInstr) {
    RISC_V_Instruction instr;
    instr.rd = (CurrentInstr >> 7) & 0x1F;
    instr.funct3 = (CurrentInstr >> 12) & 0x7;
    instr.rs1 = (CurrentInstr >> 15) & 0x1F;
    instr.rs2 = (CurrentInstr >> 20) & 0x1F;
    instr.funct7 = CurrentInstr >> 25;
    return instr;
}
